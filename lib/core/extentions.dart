// ignore_for_file: camel_case_extensions, depend_on_referenced_packages
...
extension ListExtensions<T> on List<T> {
  T? element(int index) {
    if (index >= 0 && length > index) return this[index];
    return null;
  }
}
...
String convertStringTime(String date) {
  return DateFormat.jm()
      .format(DateTime.parse(date).add(const Duration(hours: 1)));
}
